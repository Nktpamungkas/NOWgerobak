...
<!-- Main content -->
      <div class="container-fluid">       
            ...
            <div class="card-header">
              <h3 class="card-title">Data Waktu Mulai</h3>				 
            </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <table id="example1" class="table table-sm table-bordered table-striped">
                  ...
                  <tr bgcolor="<?php echo $bgcolor;?>">
                    <td align="center" width="15%" style="font-size: 15px;"><?php echo $rdtl['PROGRESSSTARTPROCESSDATE'];?></td>
                    <td align="center" width="15%" style="font-size: 15px;"><?php echo $rdtl['PROGRESSSTARTPROCESSTIME'];?></td>
                  </tr>
                  <?php $no++;}?>
                  </tbody>
                </table>
