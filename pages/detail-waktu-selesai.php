...
<head>
<title>Data Waktu Selesai</title>
...
<!-- Main content -->
      <div class="container-fluid">       
            ...
            <div class="card-header">
              <h3 class="card-title">Data Waktu Selesai</h3>				 
            </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <table id="example1" class="table table-sm table-bordered table-striped">
                  <thead>
                    <tr bgcolor="#9fc5e8">
                      <th width="15%" style="font-size: 15px;"><div align="center">Tanggal Mulai</div></th>
                      <th width="10%" style="font-size: 15px;"><div align="center">Jam Mulai</div></th>
                    </tr>
                  </thead>
                  <tbody>
                  <?php
                    ...
                    while($rdtl = db2_fetch_assoc($stmt4)){
                      $bgcolor = ($c++ & 1) ? '#33CCFF' : '#FFCC99';
                  ?>
                  <tr bgcolor="<?php echo $bgcolor;?>">
                    <td align="center" width="15%" style="font-size: 15px;"><?php echo $rdtl['PROGRESSENDDATE'];?></td>
                    <td align="center" width="15%" style="font-size: 15px;"><?php echo $rdtl['PROGRESSENDTIME'];?></td>
                  </tr>
                  <?php $no++;}?>
                  </tbody>
                </table>
