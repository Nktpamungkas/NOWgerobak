            ...
            <!-- <div class="form-group row">
               <label for="gerobak" class="col-md-1 col-form-label">Gerobak</label>  
                    ...
                    <select class="form-control select2bs4" style="width: 100%;" name="gerobak">
                      ...
                      <option value="GRB1" <?php if($Gerobak=="GRB1"){echo "SELECTED";}?>>GRB1</option>
                      <option value="GRB2" <?php if($Gerobak=="GRB2"){echo "SELECTED";}?>>GRB2</option>
                      <option value="GRB3" <?php if($Gerobak=="GRB3"){echo "SELECTED";}?>>GRB3</option>
                      <option value="GRB4" <?php if($Gerobak=="GRB4"){echo "SELECTED";}?>>GRB4</option>
                      <option value="GRB5" <?php if($Gerobak=="GRB5"){echo "SELECTED";}?>>GRB5</option>
                      <option value="GRB6" <?php if($Gerobak=="GRB6"){echo "SELECTED";}?>>GRB6</option>
                      <option value="GRB7" <?php if($Gerobak=="GRB7"){echo "SELECTED";}?>>GRB7</option>
                      <option value="GRB8" <?php if($Gerobak=="GRB8"){echo "SELECTED";}?>>GRB8</option>
                    </select>
				          </div>	 
            </div> -->
...
if($Tgl!=''){$tanggal = " AND VARCHAR_FORMAT(QUALITYDOCUMENTBEAN.IMPORTDATETIME,'YYYY-MM-DD')='$Tgl' ";}else{$tanggal ="";}
if($Tgl!='' or $Gerobak!=''){
$sqlDB2 ="SELECT 
...
LEFT JOIN (
	SELECT PRODUCTIONRESERVATION.PROJECTCODE, PRODUCTIONRESERVATION.PRODUCTIONORDERCODE 
	FROM PRODUCTIONRESERVATION PRODUCTIONRESERVATION WHERE (PRODUCTIONRESERVATION.ITEMTYPEAFICODE ='KGF' OR PRODUCTIONRESERVATION.ITEMTYPEAFICODE ='KFF' OR PRODUCTIONRESERVATION.ITEMTYPEAFICODE ='FKF' OR PRODUCTIONRESERVATION.ITEMTYPEAFICODE ='FKG') AND PRODUCTIONRESERVATION.PROJECTCODE <> ''
) A ON QUALITYDOCUMENT.PRODUCTIONORDERCODE = A.PRODUCTIONORDERCODE
...
WHERE QUALITYDOCLINE.CHARACTERISTICCODE LIKE 'GRB%' AND QUALITYDOCLINE.VALUEQUANTITY IS NOT NULL AND QUALITYDOCLINE.VALUEQUANTITY <> 0 
...
QUALITYDOCUMENTBEAN.IMPORTDATETIME";	
  ...
  LEFT JOIN QUALITYDOCUMENTBEAN QUALITYDOCUMENTBEAN ON QUALITYDOCUMENT.PRODUCTIONORDERCODE = QUALITYDOCUMENTBEAN.PRODUCTIONORDERCODE AND 
QUALITYDOCUMENT.HEADERNUMBERID = QUALITYDOCUMENTBEAN.HEADERNUMBERID AND QUALITYDOCUMENT.HEADERLINE = QUALITYDOCUMENTBEAN.HEADERLINE
  WHERE QUALITYDOCLINE.CHARACTERISTICCODE LIKE 'GRB%' AND QUALITYDOCLINE.VALUEQUANTITY IS NOT NULL AND QUALITYDOCLINE.VALUEQUANTITY <> 0 $tanggal AND QUALITYDOCLINE.VALUEQUANTITY = '$Gerobak' AND QUALITYDOCUMENTBEAN.IMPORTDATETIME IS NOT NULL
  GROUP BY 
  QUALITYDOCUMENT.PRODUCTIONORDERCODE,
  QUALITYDOCUMENT.ITEMTYPEAFICODE,
  QUALITYDOCUMENT.SUBCODE01,
