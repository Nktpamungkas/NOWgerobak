...
@media print {
    ...
    ?>
        ...
        <td colspan="22">
          <table width="100%" class="table-list1">
            <tr>
              <td width="79%"><b>Tanggal :
                  <?php echo date("d F Y", strtotime($rowlth['tgl_mutasi']));?> <br>GROUP SHIFT:
                  <?php
 echo $rowlth['gshift']; ?> <br> SHIFT :
                  <?php
 ...
 echo $rsift;?>
                  <br> No Mutasi :
                  <?php echo $rowlth['no_mutasi'];?></b></td>
              <td width="21%">
                <table width="100%" border="0" class="table-list1">
                  <tr>
      ...
      <tr align="center" bgcolor="#CCCCCC">
        ...
        <td rowspan="3" bgcolor="#F5F5F5">Bruto (Kg)</td>
