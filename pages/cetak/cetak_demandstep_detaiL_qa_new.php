...
<div class="card">
    <!-- /.card-header -->
    <div class="card-body">
    <table id="example3" border="1" cellpadding="3" cellspacing="0">
<tr>
  <th style="text-align: center">Group Step</th>
  <th style="text-align: center">Workcenter</th>
  <th style="text-align: center">Operation</th>
  <th style="text-align: center">Description</th>
  <th style="text-align: center">Progress Status</th>
  <th style="text-align: center" >QA Data (line : ket : Nr/Qty)</th>
</tr>
 </thead>
 <tbody>
 <?php	 
 $no=1;   
   $c=0;
    //$sqlDB22 = " SELECT * FROM ELEMENTSINSPECTION WHERE NUMBERGROUPSHIFT='1' AND NUMBERSHIFT='1' AND LENGTH(TRIM(ELEMENTCODE))= 13 $Where $Where1 ";
        ...
        QUALITYDOCLINE.LINE,
        CASE 
          WHEN  QUALITYDOCLINE.CHARACTERISTICCODE IS NULL THEN '-'
          ELSE  QUALITYDOCLINE.CHARACTERISTICCODE
        END AS CHARACTERISTICCODE,         
        CASE 
          WHEN  QUALITYDOCLINE.VALUEQUANTITY IS NULL THEN '0'
      ...
      QUALITYDOCUMENT.HEADERLINE = QUALITYDOCLINE.QUALITYDOCUMENTHEADERLINE
        ...
        ORDER BY PRODUCTIONDEMANDSTEP.GROUPSTEPNUMBER ASC,  QUALITYDOCLINE.LINE asc";
    ...
    $sqlQAD="SELECT DISTINCT
                ...
                --	AND QUALITYDOCUMENT.PRODUCTIONORDERCODE = QUALITYDOCLINE.QUALITYDOCPRODUCTIONORDERCODE
                ...
                WHERE 
                  ...
                  AND QUALITYDOCLINE.VALUEQUANTITY IS NOT NULL AND QUALITYDOCLINE.VALUEQUANTITY <> 0
                ORDER BY
...
<tr>
  ...
  <td><?php echo $row1['LINE']; ?> : <?php echo $row1['CHARACTERISTICCODE']; ?> : <?php echo $row1['VALUEQUANTITY']; ?></td>
</tr> 
  <?php	$no++;} ?>
  </tbody>
</table>
...
groupTable($('#example3 tr:has(td)'),0,3);
