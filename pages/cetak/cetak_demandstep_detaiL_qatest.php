...
<table id="example3" border="1" class="table-list" style="font-size:13px;">
        ...
        <tr>
          ...
          <!-- <th style="text-align: center" colspan="3">QA Data</th> -->
          </tr>       
        <tr>
          ...
          <th style="text-align: center">Nr/Qty</th> -->
        </tr>
        </thead>
        <tbody>
  </div> 
 ...
 $no=1;   
   $c=0;
    ...
    $sqlr="SELECT DISTINCT 
                ...
                LISTAGG(DISTINCT CONCAT(CONCAT(TRIM(QUALITYDOCLINE.LINE), ' : '), QUALITYDOCLINE.CHARACTERISTICCODE), ' ,    ')AS QA_DATA
              FROM PRODUCTIONDEMANDSTEP PRODUCTIONDEMANDSTEP
                ...
                LEFT JOIN QUALITYDOCLINE QUALITYDOCLINE ON QUALITYDOCUMENT.HEADERLINE = QUALITYDOCLINE.QUALITYDOCUMENTHEADERLINE
...
?>
    <tr>
      <!-- <td align="center" width="1%" rowspan='2'><?php echo $no; ?></td> -->
	    <td align="center" width="3%"><?php echo $row1['GROUPSTEPNUMBER']; ?></td>
      ...
      <td align="center" width="5%"><?php echo $rQAD['LINE']; ?></td>
      <td align="center" width="5%"><?php echo $rQAD['LONGDESCRIPTION']; ?></td>
      <td align="center" width="5%"><?php echo $rQAD['VALUEQUANTITY']; ?></td>
      <?php } ?>       -->
    </tr>
    <tr>
