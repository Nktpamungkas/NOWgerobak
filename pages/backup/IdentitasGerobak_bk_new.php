...
?>
      ...
      <td align="center"><a href="#" class="btn btn-warning btn-xs" onClick="window.open('pages/detail-qa-data.php?id=<?php echo $row1['PRODUCTIONORDERCODE']; ?>&wct=<?php echo $row1['WORKCENTERCODE']; ?>&opt=<?php echo $row1['OPERATIONCODE']; ?>','MyWindow','height=400,width=600,top=250,left=530');"><i class="fa fa-edit"></i></a></td>
