...
<!-- Main content -->
      <div class="container-fluid">       
            ...
            <div class="card-header">
              <h3 class="card-title">Detail QA Data</h3>				 
            </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <table id="example1" class="table table-sm table-bordered table-striped">
                  <thead>
                    <tr bgcolor="#9fc5e8">
                      <th width="15%"><div align="center">Line</div></th> 
                      <th width="15%"><div align="center">Deskripsi</div></th>
                      <th width="10%" style="font-size: 15px;"><div align="center">Nr/QTY</div></th>
                    </tr>
                  </thead>
                  <tbody>
                  <?php
                    ...
                    $sqldtl="SELECT DISTINCT
                              ...
                              CASE 
                                ...
                                ELSE  QUALITYDOClINE.VALUEQUANTITY
                            ...
                            WHERE QUALITYDOCUMENT.OPERATIONCODE='$opt' AND QUALITYDOCUMENT.WORKCENTERCODE ='$wct' AND 
                                  QUALITYDOClINE.QUALITYDOCPRODUCTIONORDERCODE ='$modal_id'
                  ...
                  <tr bgcolor="<?php echo $bgcolor;?>">
                    <td align="center" width="15%"><?php echo $rdtl['LINE'];?></td>
                    <td align="center" width="15%"><?php echo $rdtl['LONGDESCRIPTION'];?></td> 
                    <td align="center" width="15%"><?php echo $rdtl['VALUEQUANTITY'];?></td>                  
                  </tr>
                  <?php $no++;}?>
                  </tbody>
                </table>
